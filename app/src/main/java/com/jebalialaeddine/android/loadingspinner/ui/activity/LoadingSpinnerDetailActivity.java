...
/**
 * An activity representing a single LoadingSpinner detail screen. This
 * activity is only used on handset devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link LoadingSpinnerListActivity}.
 * <p/>
 * This activity is mostly just a 'shell' activity containing nothing
 * more than a {@link com.jebalialaeddine.android.loadingspinner.ui.fragment.LoadingSpinnerDetailFragment}.
 */
public class LoadingSpinnerDetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.loadingspinner_detail_container, fragment)
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            NavUtils.navigateUpTo(this, new Intent(this, LoadingSpinnerListActivity.class));
            return true;
        }
